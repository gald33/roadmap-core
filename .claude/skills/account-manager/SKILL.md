...
```bash
org tempo --repo /home/user/roadmap-core register --role account-manager     # your agent id into coord/tempo/agents, so senders can wake you; answers `listener_alive` for step 6
...
field, then `org tempo --repo /home/user/roadmap-core dm --role ceo "blocked_written account-manager"` —
